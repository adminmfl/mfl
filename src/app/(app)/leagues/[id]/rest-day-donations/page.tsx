...
export default function RestDayDonationsPage() {
  ...
  const teamOptions = React.useMemo(() => {
    ...
    members.forEach((member) =>
      names.add(normalizedTeamName(member.team_name)),
    );
  ...
  const filteredMembers = React.useMemo(() => {
    ...
    return members.filter(
      (member) => normalizedTeamName(member.team_name) === selectedTeam,
    );
  ...
  const isCaptain = userRole === 'captain' || userRole === 'vice_captain';
  ...
  const captainApprovedDonations = donations.filter(
    (d) => d.status === 'captain_approved',
  );
  const myDonations = donations.filter(
    (d) =>
      d.donor.member_id === userMemberId ||
      d.receiver.member_id === userMemberId,
  );
    ...
    return (
      <div className="container max-w-4xl mx-auto py-6 text-center space-y-4">
        ...
        <p className="text-muted-foreground">
          Rest days are not enabled for this league.
        </p>
  ...
  return (
    <div className="container max-w-4xl mx-auto py-6 space-y-6">
      ...
      <Tabs
        defaultValue={isGovernorOrHost || isCaptain ? 'approval' : 'request'}
        className="space-y-4"
      >
        <TabsList>
        ...
        <TabsContent value="request">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Donate to any league member. Requires captain approval first,
                then governor/host approval.
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={setReceiverMemberId}
                            ...
                            <div className="flex items-center justify-between gap-4">
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  {d.days_transferred}{' '}
                                  {d.days_transferred === 1 ? 'day' : 'days'}
                                </p>
                              </div>
                              <Badge
                                variant="outline"
                                className="text-yellow-500 border-yellow-500/20 shrink-0"
                              >
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              <div className="flex gap-2 shrink-0">
                                <Button
                                  ...
                                  variant="default"
                                  onClick={() =>
                                    handleUpdateStatus(d.id, 'approve')
                                  }
                                >
                                ...
                                <Button
                                  ...
                                  variant="destructive"
                                  onClick={() =>
                                    handleUpdateStatus(d.id, 'reject')
                                  }
                                >
