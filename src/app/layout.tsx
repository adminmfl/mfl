...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Fitness Challenges For Teams. Create leagues, build teams, and track workouts together.',
...
export default async function RootLayout({
  ...
  return (
    <html
      ...
      className={`${manrope.variable} ${inter.variable} ${plusJakarta.variable} ${dmSans.variable} ${outfit.variable} ${bebasNeue.variable} ${dmMono.variable} font-manrope`}
    >
      <head>
        ...
        <link
          rel="preload"
          href="/img/mfl-logo.jpg?width=100&quality=80"
          as="image"
        />
      </head>
